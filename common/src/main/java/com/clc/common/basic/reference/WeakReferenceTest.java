...
import static com.clc.common.basic.reference.StrongReference.deleteOldDumps;
import static com.clc.common.basic.reference.StrongReference.runGC;
...
public class WeakReferenceTest {
    public static void main(String[] args) throws InterruptedException {
        ...
        HeapDump.dumpHeap("common/heap-dumps/weakRefBeforeGCEligible.hprof", false);
        a2 = null;
        ...
        HeapDump.dumpHeap("common/heap-dumps/weakRefBeforeGC.hprof", false);
        runGC();
        HeapDump.dumpHeap("common/heap-dumps/weakRefAfterGC.hprof", false);
